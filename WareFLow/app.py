...
class WareFlowApp:
    def __init__(self):
        """Initialize the WareFlow application"""
        st.set_page_config(
            page_title="WareFlow: Inventory Management System",
            page_icon="🏭",
            layout="wide"
        )
    ...
    def login_page(self):
        """Display login page"""
        st.title("WareFlow : Inventory Management")
    ...
    def show_guide(self):
        ...
        st.title("📚 WareFlow User Guide")
        
        # Introduction
        st.markdown("""
        Welcome to WareFlow - Your Comprehensive Inventory Management System! 
    ...
    def run(self):
        ...
        st.title("🏭 WareFlow: Inventory Management System")
